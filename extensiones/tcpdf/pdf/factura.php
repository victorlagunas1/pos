...
$bloque1 = <<<EOF
	...
	<table>
		...
		<td style="background-color:white; width:10px"> </td>
			...
			<br>
			<div style="font-size:9px; text-align:center; line-height:10px;">$sucursal[direccion]</div>
			</td>
...
$bloque8 = <<<EOF
	...
	<table>
		...
		<div style="font-size:6px; text-align:left; line-height:7px;">$sucursal[terminos]</div> 
