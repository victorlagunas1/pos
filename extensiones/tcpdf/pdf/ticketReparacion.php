...
if ($traerReparacion["anticipo"] != 0){



$totalFormato2 = number_format($traerReparacion["anticipo"],2); 
$diferencia = number_format($traerReparacion["precio"]-$traerReparacion["anticipo"],2); 
$bloque5 = <<<EOF
	...
	<table>
		...
		<td style="background-color:white; width:5px"> </td>
			...
			<div style="font-size:9px; text-align:right; line-height:4px;"><b>Diferencia: $ $diferencia</b></div> 
			<br>
...
$totalFormato2 = number_format($traerReparacion["precio"],2); 
$bloque5 = <<<EOF
	...
	<table>
		...
		<td style="background-color:white; width:5px"> </td>
			...
			<div style="font-size:9px; text-align:center; line-height:4px;"><b>Garantía hasta: </b> $traerReparacion[vigencia_garantia]</div> 
			<br>
