...
$('.tablaRefaccionesSucursal').DataTable( {
    "ajax": "ajax/datatable-refacciones-sucursal.ajax.php",
    "ajax": "ajax/datatable-refacciones-sucursal.ajax.php?idSucursal="+$(idSucursal).val()+"&perfilId="+$(perfilId).val(),
    "deferRender": true,
    "pageLength" : 50,
  "retrieve": true,
  "processing": true,
...
$(".tablaRefaccionesSucursal tbody").on("click", "button.btnEtiquetaRefaccion", function(){
...
=============================================*/
$(".tablaRefaccionesSucursal tbody").on("click", "button.btnSeccionRefaccion", function(){
...
$(".tablaRefaccionesSucursal tbody").on("click", "button.btnEditarRefaccion", function(){
...
$(".tablaRefaccionesSucursal tbody").on("click", "button.btnStockRefaccion", function(){
...
$(".tablaRefaccionesSucursal tbody").on("click", "button.btnEliminarRefaccion", function(){
  ...
  swal({
    ...
    type: 'warning',
        ...
        if (result.value) {
          ...
          window.location = "index.php?ruta=refacciones-sucursal&idRefaccionEliminar="+idRefaccionEliminar;
