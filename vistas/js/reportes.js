...
if(localStorage.getItem("capturarRango3") != null){
  ...
  $("#daterangeRendimientoSucursal-btn span").html(localStorage.getItem("capturarRango3"));


}else{

    $("#daterangeRendimientoSucursal-btn span").html('<i class="fa fa-calendar"></i> Rango de fecha')
...
/*=============================================
REPORTES DE VENTAS ESTADISTICOS
=============================================*/


  $('#daterangeRendimientoSucursal-btn').daterangepicker(
  ...
  function (start, end) {
    $('#daterangeRendimientoSucursal-btn span').html(start.format('MMMM D, YYYY') + ' - ' + end.format('MMMM D, YYYY'));
    ...
    var capturarRango3 = $("#daterangeRendimientoSucursal-btn span").html();
...
CANCELAR RANGO DE FECHAS
=============================================*/
$('button[name="daterangeRendimientoSucursal-btn"]').on('cancel.daterangepicker', function(ev, picker) {

  localStorage.removeItem("capturarRango3");
  localStorage.clear();
  window.location = "sucursales-estadistico";
