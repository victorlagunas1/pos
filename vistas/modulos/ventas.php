    ...
    <div class="box">
      ...
      <div class="box-header with-border">
        ...
        <a href="crear-venta">
         ...
         <button type="button" name="datepicker1" class="btn btn-default pull-right" id="daterange-btn" >
                  ...
                  <td>
                    ...
                    <div class="btn-group">
                      ...
                      <button class="btn btn-info btnImprimirFactura" codigoVenta="'.$value["codigo"].'">
                       ...
                       <button class="btn btn-primary btnDatosFactura" codigoVenta="'.$value["codigo"].'" data-toggle="modal" data-target="#modalAgregarFacturacion">
                      ...
                      echo '<button class="btn btn-warning btnEditarVenta" idVenta="'.$value["id"].'"><i class="fa fa-pencil"></i></button><button class="btn btn-danger btnEliminarVenta" idVenta="'.$value["id"].'"><i class="fa fa-times"></i></button>';
