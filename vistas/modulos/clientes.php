          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="editarCliente" id="editarCliente" autocomplete="off" required>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" min="0" class="form-control input-lg" name="editarDocumentoId" id="editarDocumentoId" autocomplete="off" required>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="email" class="form-control input-lg" name="editarEmail" id="editarEmail" autocomplete="off" required>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="editarTelefono" id="editarTelefono" data-inputmask="'mask':'(999) 999-9999'" data-mask autocomplete="off" required>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="editarDireccion" id="editarDireccion"  autocomplete="off" required>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="editarFechaNacimiento" id="editarFechaNacimiento"  data-inputmask="'alias': 'yyyy/mm/dd'" autocomplete="off" data-mask required>
