...
if($_SESSION["perfil"] != "Administrador" && $_SESSION["perfil"] != "Administrador de Sucursal" && $_SESSION["perfil"] != "Técnico Reparador"){
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <?php 
      ...
      $porEntregar = ModeloCotizaciones::mdlMostrarFetchAll($tabla, $item, $valor, $orden); 

      $item = "status";
      $valor = "0";
      //$sucursal = ;

      $pendientes = ModeloCotizaciones::mdlMostrarFetchAll($tabla, $item, $valor, $orden);

      $item = "status";
      $valor = "1";
      //$sucursal = ;

      $revision = ModeloCotizaciones::mdlMostrarFetchAll($tabla, $item, $valor, $orden);

      $item = "status";
      $valor = "6";
      //$sucursal = ;

      $contactar = ModeloCotizaciones::mdlMostrarFetchAll($tabla, $item, $valor, $orden);
    ...
    <div class="box">
      ...
      <div class="box-header with-border">
        ...
        <button class="btn btn-primary btnAgregarReparacion" data-toggle="modal" data-target="#modalAgregarReparacion">
         ...
         <button class="btn btn-danger pull-right" style="margin-left:5px" onClick="history.go(-1)">
        ...
        <button class="btn btn-primary pull-right " onclick="location.href='refacciones-sucursal'">
...
<dl class="dl-horizontal col-xs-6 col-sm-6 hidden">
 ...
 <?php
         if($_SESSION["perfil"] == "Administrador"){
          ...
          echo '<button type="button" class="btn btn-warning" data-toggle="modal" data-target="#modalEditarReparacion" data-dismiss="modal" btnInfoReparacion>Configuración</button>';
        }
?>
